...
##Creating Data
pos_tweets =  rbind(
  c('They deserve great credit', 'positive'),
  c('Happy Day', 'positive'),
  c('This is a big day', 'positive'),
...
neutral_tweets = rbind(
  c('I do not like this car', 'neutral'),
  c('This view is horrible', 'neutral'),
  c('I feel tired this morning', 'neutral'),
  c('I am not looking forward to the concert', 'neutral'),
  c('He is my enemy', 'neutral')
)
